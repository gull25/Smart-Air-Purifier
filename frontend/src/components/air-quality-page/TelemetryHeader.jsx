...
const TelemetryHeader = () => {
  return (
    <div className="w-full py-space-lg flex flex-col xl:flex-row xl:items-center justify-between gap-space-md items-center xl:items-start text-center xl:text-left">
      <div className="flex flex-col gap-space-2xs items-center xl:items-start">
        <div className="flex items-center justify-center xl:justify-start gap-space-xs text-primary font-label-caps uppercase tracking-wider">
      ...
      <div className="flex flex-wrap items-center justify-center xl:justify-start gap-space-sm">
